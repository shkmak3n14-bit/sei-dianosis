...
const ENNEAGRAM_TYPES = [
	...
	},
	{
		...
		questions: [
			...
			"相手の気持ちや反応に強く影響され、行動が左右されやすい。",
			"関係がどう見えるかを気にしてしまうことが多い。",
			// ◆ 承認欲求・必要とされたい気持ち（動機を明確化）
			"人の役に立つことで、相手との関係が深まると感じることがある。",
			"人を助けることで、自分が必要とされていると感じることがある。",
			"感謝されないと不安になることがある。",
			"人のために動くことで自分の価値を感じる。",
			// ◆ 自己犠牲・ニーズの後回し
			"自分のニーズよりも相手の気持ちや期待を優先してしまい、結果的に自分のことが後回しになりやすい。",
			...
			"人との距離が自然と近くなり、相手のパーソナルスペースに入っても不快に思われないことが多い。",
			// ◆ 怒りの抑制・関係維持の優先
	...
	},
	{
		...
		questions: [
			"目標を達成することが大きな喜びになる。",
			"効率的に動くことを好む。",
			"感情が湧いても、まずはやるべきことを片付けようとして後回しにしがちだ。",
			"人からどう見られるかを意識する。",
			"成果が出ないと不安になる。",
			"自分の価値を成果で測りがち。",
			"期待に応えることが成果や評価につながると感じ、効率よく結果を出そうと頑張ることが多い。",
			"競争心がある。",
			"弱さを見せると評価やイメージが崩れる気がして、つい強い自分を保とうとしてしまう。",
			"役割に合わせて自分を変えることがある。",
			"効率の悪さにイライラすることがある。",
			"成果が出ると気分が上がる。",
			"感情よりも、成果や評価を優先することが自分の中で自然に感じられる。",
			"進めていた段取りや効率が崩れると、成果が遅れそうで強いストレスを感じやすい。",
			"成功している自分でいたい。"
		]
	},
	{
		...
		questions: [
			...
			"感情が複雑で説明しにくい。",
			"自分の価値を感情で測ることがある。",
			"他人の感情の動きや雰囲気の変化に敏感で、その意味を深く感じ取ろうとすることが多い。",
			"自分の感情を大事にしたい。",
			"感情が強すぎて疲れることがある。",
			"自分の世界観を守りたい。",
			"感情が孤独感につながることがある。"
